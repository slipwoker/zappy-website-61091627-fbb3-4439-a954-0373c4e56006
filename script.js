    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אושר מחשבים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '61091627-fbb3-4439-a954-0373c4e56006',
                    name: data.name || '',
                    email: data.email || '',
